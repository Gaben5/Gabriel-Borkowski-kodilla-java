...
public class PriceList {
    private static Map<Season, BigDecimal> sindgleBedPrices = Map.of(
    ...
    public static BigDecimal getSindgleBedPrices(Season season) {
        return sindgleBedPrices.get(season);
    }
