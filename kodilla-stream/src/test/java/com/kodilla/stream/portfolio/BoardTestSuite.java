...
public class BoardTestSuite {
    ...
    private Board prepareTestData(){
        ...
        User user2 = new User("projectmanaget1","Nina White");
        User user3 = new User("developer2","Emilia Stepganson");
        User user4 = new User("developer3","Konrad Brigde");
        //tasks
        ...
        //board
        Board project = new Board("Project Weather Prediciton");
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        List<TaskList> inProgressTasks = new ArrayList<>();
        inProgressTasks.add(new TaskList("In Progress"));
        OptionalDouble avgDays = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
                .flatMap(tl -> tl.getTasks().stream())
                .map(Task::getCreated)
        ...
        //Then
        assertEquals(10,abs(avgDays.getAsDouble()),0.001);
